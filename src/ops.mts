...
export function riskScan(root: string): RiskFinding[] {
...
export function riskCommand(options: CliOptions): void {
...
export function retentionPolicy(root: string): RetentionPolicy {
...
export function retention(options: CliOptions): void {
  const root = targetFrom(options);
...
export function gateAudit(options: CliOptions): void {
  const root = targetFrom(options);
...
export function rotateLedgerIfLarge(path: string): void {
  try {
